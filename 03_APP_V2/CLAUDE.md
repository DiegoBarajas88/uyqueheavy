...
- `design/cartas/` — cartas Family/Storytime generadas con la plantilla del mazo impreso (`make_cards_family_storytime.py`, geometría medida del PDF de imprenta en `../ANTIGUO ARCHIVO/Producto/`). Prototipo de barajado físico aprobado por Erika el 2026-09-09 (artifact). Pendiente llevarlo a la app.
