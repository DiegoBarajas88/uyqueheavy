...
export const editions: Edition[] = [
  ...
  },
  {
    ...
    theme: 'Introspectivo',
    description: 'Una edición para escuchar el interior, hablar de deseos y proyectar futuro con honestidad.',
    categories: [
      { key: 'identidad', label: 'Identidad', description: 'Explorar quién eres hoy y cómo te expresas.' },
      { key: 'historia', label: 'Historia', description: 'Compartir recuerdos y el camino que te define.' },
      { key: 'creencias', label: 'Creencias', description: 'Profundizar en tus valores y tu forma de ver el mundo.' },
      { key: 'miedos', label: 'Miedos', description: 'Nombrar aquello que aún te inquieta o te detiene.' },
      { key: 'proposito', label: 'Propósito', description: 'Clarificar deseos, decisiones y próximos pasos.' }
    ],
    cards: [
      { id: 'forever-01', text: '¿Hay alguna fantasía que te gustaría compartir conmigo y explorar juntos?', category: 'identidad' },
      { id: 'forever-02', text: '¿Cómo prefieres que te exprese mis deseos en la intimidad para que te sientas cómodo y conectado?', category: 'identidad' },
      { id: 'forever-03', text: '¿Qué parte de nuestro tiempo juntos disfrutas más y te gustaría repetir con frecuencia?', category: 'historia' },
      { id: 'forever-04', text: '¿Qué es algo de tu cuerpo que te gustaría que notara más durante nuestros momentos íntimos?', category: 'identidad' },
      { id: 'forever-05', text: 'En el sexo me desmotiva mucho que…', category: 'miedos' },
      { id: 'forever-06', text: 'Para mí, la familia y la intimidad son…', category: 'creencias' },
      { id: 'forever-07', text: 'Tienes algún límite claro o que no te sientas cómodo explorando', category: 'miedos' },
      { id: 'forever-08', text: '¿Qué te ayuda a relajarte y disfrutar más plenamente de nuestra intimidad?', category: 'creencias' },
      { id: 'forever-09', text: '¿Qué ambiente o detalles te hacen sentir más a gusto y libre en nuestra intimidad?', category: 'creencias' },
      { id: 'forever-10', text: '¿Qué palabras o gestos te hacen sentir más amado y seguro en nuestros momentos íntimos?', category: 'creencias' },
      { id: 'forever-11', text: '¿Hay algo que hayas visto o escuchado que te gustaría que probáramos juntos?', category: 'historia' },
      { id: 'forever-12', text: '¿Qué cosas sutiles en el día a día te hacen sentir más atraído?', category: 'creencias' },
      { id: 'forever-13', text: '¿Qué es lo que más disfrutas que haga por ti en nuestra vida íntima?', category: 'historia' },
      { id: 'forever-14', text: '¿Qué tipo de palabras o frases te hacen sentir deseado y conectado conmigo?', category: 'creencias' },
      { id: 'forever-15', text: '¿Te gustaría que probáramos un nuevo lugar o ambiente para disfrutar juntos?', category: 'proposito' },
      { id: 'forever-16', text: '¿Hay algo sobre mi sexualidad o preferencias que te gustaría comprender mejor?', category: 'identidad' },
      { id: 'forever-17', text: '¿Qué aspecto de nuestras finanzas te genera más tranquilidad, y cuál te gustaría que mejoráramos?', category: 'proposito' },
      { id: 'forever-18', text: '¿En qué te gustaría que nos apoyáramos más para tomar decisiones financieras juntos?', category: 'proposito' },
      { id: 'forever-19', text: '¿Cómo crees que deberíamos gestionar los gastos personales y los gastos compartidos?', category: 'proposito' },
      { id: 'forever-20', text: '¿Qué es lo más importante para ti al momento de ahorrar o invertir?', category: 'proposito' },
      { id: 'forever-21', text: '¿Qué consejo financiero te gustaría compartir conmigo que crees que aún no hemos considerado?', category: 'proposito' },
      { id: 'forever-22', text: '¿Qué decisión financiera crees que ha sido clave para nuestro bienestar actual?', category: 'proposito' },
      { id: 'forever-23', text: '¿Cómo describirías tu relación con el dinero, y cómo sientes que se complementa con la mía?', category: 'creencias' },
      { id: 'forever-24', text: '¿Hay algo que no te he preguntado sobre tu vida íntima y que te gustaría que supiera?', category: 'historia' }
    ]
  },
  {
    key: 'family',
